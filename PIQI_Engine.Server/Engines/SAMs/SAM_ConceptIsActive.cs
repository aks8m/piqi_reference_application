...
{
    /// <summary>
    /// SAM implementation that checks if a <see cref="CodeableConcept"/> contains at least one active coding.
    /// </summary>
    public class SAM_ConceptIsActive : SAMBase
    {
        /// <summary>
        ...
        /// <list type="bullet">
        ///   <item><c>Succeeded</c> if at least one coding is active.</item>
        ///   <item><c>Failed</c> if no codings are active.</item>
        ...
        public override async Task<PIQISAMResponse> EvaluateAsync(PIQISAMRequest request)
        {
            ...
            try
            {
                ...
                if (data is not CodeableConcept)
                    throw new Exception("CodeableConceptIsActive expects a codeable concept value.");
