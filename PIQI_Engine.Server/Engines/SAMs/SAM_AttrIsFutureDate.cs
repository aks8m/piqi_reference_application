...
{
    /// <summary>
    /// SAM implementation that checks if an attribute's value is a future date.
    /// </summary>
    public class SAM_AttrIsFutureDate : SAMBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SAM_AttrIsFutureDate"/> class.
        /// </summary>
        /// <param name="sam">The SAM object associated with this evaluator.</param>
        /// /// <param name="samService">
        /// An implementation of <see cref="SAMService"/> used to access reference data and make FHIR API calls.
        /// </param>
        public SAM_AttrIsFutureDate(SAM sam, SAMService samService) : base(sam, samService) { }

        /// <summary>
        /// Evaluates whether the text value of a message attribute represents a valid <see cref="DateTime"/>
        /// that occurs in the future relative to the current system time.
        /// </summary>
        /// <param name="request">
        ...
        /// The <see cref="PIQISAMResponse"/> indicates whether the datetime value is in the future,
        ...
        /// <item><description>The datetime occurs after the current system time (<see cref="DateTime.Now"/>).</description></item>
        /// </list>
        /// </remarks>
